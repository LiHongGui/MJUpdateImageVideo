...
{
    [self layoutCropRectViewWithCropRect:CGRectMake(0, 0, self.scrollView.bounds.size.height, self.scrollView.bounds.size.width)];
//    self.cropRectView.frame = CGRectMake(0, 0, self.bounds.size.height, self.bounds.size.width);
//    self.cropRectView.transform = CGAffineTransformRotate(self.cropRectView.transform, M_PI/2);
}
#pragma mark -
...
- (void)layoutCropRectViewWithCropRect:(CGRect)cropRect
{
    ...
    NSLog(@"cropRect:%@",NSStringFromCGRect(cropRect));//2020-01-08 21:05:34.437120+0800 222[36556:2091448] cropRect:{{57.473684210526329, 37}, {260.05263157894734, 549}}
